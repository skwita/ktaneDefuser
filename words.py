...
class Words:
    ...
    def __init__(self, master):
        ...
        self.word_combobox1 = ttk.Combobox(self.row1, values=self.word_array)
        self.word_combobox1.pack(side='left', padx=5, pady=5)
        self.word_combobox2 = ttk.Combobox(self.row1, values=self.word_array)
        self.word_combobox2.pack(side='left', padx=5, pady=5)
        self.row1.pack()

        self.row2 = tk.Frame(self.top)
        self.word_combobox3 = ttk.Combobox(self.row2, values=self.word_array)
        self.word_combobox3.pack(side='left', padx=5, pady=5)
        self.word_combobox4 = ttk.Combobox(self.row2, values=self.word_array)
        self.word_combobox4.pack(side='left', padx=5, pady=5)
        self.row2.pack()

        self.row3 = tk.Frame(self.top)
        self.word_combobox5 = ttk.Combobox(self.row3, values=self.word_array)
        self.word_combobox5.pack(side='left', padx=5, pady=5)
        self.word_combobox6 = ttk.Combobox(self.row3, values=self.word_array)
        self.word_combobox6.pack(side='left', padx=5, pady=5)
        self.row3.pack()

        self.row4 = tk.Frame(self.top)
        self.btn_do = tk.Button(self.row4, text='определить!', command=self.proceed)
        self.btn_do.pack()
        self.row4.pack()

        self.row5 = tk.Frame(self.top)
        self.lbl = tk.Label(self.row5)
